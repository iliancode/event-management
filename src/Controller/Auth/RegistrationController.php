...
class RegistrationController extends AbstractController
{
    ...
    #[Route('/register', name: RouteConstants::ROUTE_REGISTER)]
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, CustomAuthenticator $authenticator, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation(RouteConstants::ROUTE_VERIFY_EMAIL, $user,
                (new TemplatedEmail())
                    ->from(new Address('esgi-events@alwaysdata.com', 'ESGI EVENTS'))
                    ->to($user->getEmail())
    ...
    #[Route('/verify/email', name: RouteConstants::ROUTE_VERIFY_EMAIL)]
